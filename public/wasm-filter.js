...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'wasm-filter.wast';
  var wasmBinaryFile = 'wasm-filter.wasm';
  var asmjsCodeFile = 'wasm-filter.temp.asm.js';
...
var real__outline_c = asm["_outline_c"]; asm["_outline_c"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__outline_c.apply(null, arguments);
};
...
var _outline_c = Module["_outline_c"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_outline_c"].apply(null, arguments) };
